...
def build(g):
    ...
    # 외곽권 생활권 확장(2,000자+) — 택지·산단·행정 중심 고유 콘텐츠
    EXTRA_BODY.update({
      "anseong-gongdo": [
        ("공도읍 택지·아파트 안내",
         "공도읍은 안성에서 가장 개발이 활발한 택지지구로, 스타필드 안성 인근 신축 대단지 아파트와 근린상가가 조성돼 있습니다. 신축 대단지는 방문 차량 등록과 지하주차 세대 출입이 일반적이라 단지명과 동·호수를 미리 확인합니다. 공도는 평택 고덕·지제와 가까워 인근 이동 문의도 함께 들어옵니다."),
        ("안성 시내·대학가 안내",
         "안성 시내는 안성맞춤랜드와 안성중앙시장, 한경대·중앙대 안성캠퍼스를 낀 원도심 생활권입니다. 시내 주택가와 원룸·빌라, 봉산동 상권이 섞여 있어 건물 유형에 따라 공동현관 방식이 달라 정확한 주소를 먼저 확인합니다."),
        ("안성 이동·외곽 기준",
         "안성은 철도가 없어 중부고속도로 안성IC와 국도를 통한 자차 이동이 기본입니다. 시내·공도·대덕·죽산 등 지역 간 거리가 상당하므로 정확한 도로명 주소와 가까운 생활권을 함께 알려주시면 이동과 예약 시간 안내가 빠릅니다."),
      ],
      "cheoin-jungang": [
        ("역북지구 신축 단지 안내",
         "역북동 일대는 용인 원도심에서 가장 활발히 개발된 택지지구로, 신축 대단지 아파트와 근린상가가 조성돼 있습니다. 신축 대단지는 방문 차량 등록과 지하주차 세대 출입이 일반적이라 단지명과 동·호수를 미리 확인합니다."),
        ("김량장·용인중앙시장 원도심",
         "김량장동은 용인중앙시장과 처인구청을 낀 용인의 원도심 상권으로, 주택·빌라·상가가 밀집합니다. 원도심은 공동현관 방식이 제각각이라 정확한 도로명 주소와 출입 방법을 먼저 확인합니다."),
        ("처인 외곽·이동 기준",
         "처인구는 면적이 넓어 김량장 도심 외에 남사·이동·백암 등 외곽이 포함됩니다. 외곽은 이동 거리가 상당하므로 정확한 주소와 예약 가능 시간을 함께 확인해야 방문이 원활합니다."),
      ],
      "gwoldong-unam": [
        ("궐동 대학가·주거 안내",
         "궐동은 대학가와 주거가 섞인 지역으로 원룸·오피스텔과 아파트가 함께 있습니다. 원룸·오피스텔은 공동현관 비밀번호, 아파트는 방문 차량 등록이 필요할 수 있어 예약 시 건물 유형을 알려주시면 안내가 빠릅니다."),
        ("운암·오산시청 행정 주거권",
         "운암동은 오산시청 인접 행정·주거권으로 대단지 아파트와 근린상가가 자리합니다. 대단지는 방문 차량 등록과 동별 공동현관 출입이 일반적이라 단지명과 동·호수를 미리 확인합니다."),
        ("궐동·운암 이용·이동 기준",
         "궐동·운암은 오산역·세교와 가까워 인근 생활권과 이동 문의가 함께 들어옵니다. 방문은 오산 실제 주소 기준으로 안내되며, 원룸·오피스텔은 공동현관 출입 방식을 미리 확인하면 원활합니다."),
      ],
      "hwaseong-namyang": [
        ("남양읍 행정 중심 안내",
         "남양읍은 화성시청과 행정타운을 낀 화성 서부 행정 중심으로, 신축 아파트와 주택가가 함께 조성돼 있습니다. 대단지는 방문 차량 등록과 동별 공동현관 출입이 일반적이라 단지명과 동·호수를 미리 확인합니다."),
        ("송산·새솔동 신도시 확장",
         "송산그린시티 새솔동은 서해안권으로 확장 중인 신도시로, 신축 대단지 아파트가 조성되고 있습니다. 신축 단지는 지하주차 세대 출입과 방문 차량 등록이 필요해 진입 동선을 미리 확인합니다."),
        ("화성 서부 외곽·이동 기준",
         "남양·송산·서신·마도 등 화성 서부는 면적이 넓고 해안권까지 포함돼 이동 거리가 상당합니다. 정확한 도로명 주소와 가까운 생활권, 예약 가능 시간을 함께 확인해야 방문이 원활합니다."),
      ],
      "hyangnam-bongdam": [
        ("향남읍 택지·제약단지 안내",
         "향남읍은 향남제약단지와 발안 상권을 낀 화성 서남부 신흥 주거권으로, 향남1·2택지지구 대단지 아파트가 조성돼 있습니다. 신축 대단지는 방문 차량 등록과 지하주차 세대 출입이 일반적이라 단지명과 동·호수를 미리 확인합니다."),
        ("봉담읍 택지지구 특징",
         "봉담읍은 수원 접경 택지지구로 대단지 아파트가 빠르게 늘고 있습니다. 수원 권선·호매실 생활권과 가까워 인근 이동 문의도 함께 들어오지만, 방문은 봉담 실제 주소 기준으로 안내됩니다."),
        ("향남·봉담 이동·산단 기준",
         "향남·봉담은 철도역이 없어 자차·버스 이동이 기본입니다. 제약단지·산업시설 인접 숙소는 방문자 출입과 이동 가능 시간을 먼저 확인하며, 정확한 도로명 주소와 가까운 생활권을 함께 확인합니다."),
      ],
      "icheon-bubal": [
        ("증포지구 신축 단지 안내",
         "증포동 일대는 이천 시내에서 가장 활발히 개발된 택지지구로, 신축 대단지 아파트와 근린상가가 조성돼 있습니다. 신축 대단지는 방문 차량 등록과 지하주차 세대 출입이 일반적이라 단지명과 동·호수를 미리 확인합니다."),
        ("부발읍·SK하이닉스 배후 안내",
         "부발읍은 SK하이닉스 이천캠퍼스 배후 주거·산단 생활권으로, 오피스텔·원룸과 아파트가 함께 있습니다. 반도체 산단 인접으로 장기 이용 문의가 이어지며, 오피스텔은 방문자 출입과 주차 정책을 먼저 확인합니다."),
        ("이천 이동·외곽 기준",
         "이천은 경강선 이천역·부발역으로 판교·여주 이동이 가능하나 시내·부발·장호원 등 지역 간 거리가 상당합니다. 정확한 도로명 주소와 가까운 역·생활권, 예약 가능 시간을 함께 확인해야 방문이 원활합니다."),
      ],
    })
    EXTRA_FAQ.update({
      "anseong-gongdo": [("안성 공도읍도 방문 가능한가요?",
        "공도 신축 대단지는 방문 차량 등록과 지하주차 세대 출입 기준을 확인한 뒤 안내합니다. 다만 외곽 특성상 이동 거리와 예약 가능 시간을 함께 확인합니다.")],
      "cheoin-jungang": [("처인구 외곽도 방문 가능한가요?",
        "외곽 지역은 정확한 주소와 이동 가능 시간, 예약 가능 시간을 확인한 뒤 안내합니다. 김량장·역북 도심은 상대적으로 이동이 수월합니다.")],
      "gwoldong-unam": [("궐동 원룸·오피스텔도 방문 가능한가요?",
        "공동현관 비밀번호나 방문자 등록 방식을 확인한 뒤 안내합니다. 건물명과 호수를 미리 알려주시면 안내가 빠릅니다.")],
      "hwaseong-namyang": [("화성 서부 해안권도 방문 가능한가요?",
        "서부 해안권은 이동 거리가 길어 정확한 주소와 이동 가능 시간, 예약 가능 시간을 확인한 뒤 안내합니다.")],
      "hyangnam-bongdam": [("향남·봉담 산단 인근 숙소도 방문 가능한가요?",
        "산단 인접 숙소는 방문자 출입과 이동 가능 시간을 확인한 뒤 안내합니다. 정확한 주소와 예약 가능 시간을 함께 확인합니다.")],
      "icheon-bubal": [("부발 산단 인근 오피스텔도 방문 가능한가요?",
        "방문자 출입과 주차 정책이 건물마다 달라 건물명과 호수, 이동 가능 시간을 확인한 뒤 안내합니다.")],
    })
    TIP.update({
      "anseong-gongdo": ("안성 이용 시 참고",
        "안성은 산업단지 배후 이용과 가족 주거 이용이 섞여 있어 스포츠 마사지·스웨디시 문의가 함께 들어옵니다. 외곽 지역은 이동 거리에 따라 예약 가능 시간이 달라지므로 정확한 주소를 예약 시 미리 알려주시면 원활합니다."),
      "cheoin-jungang": ("처인·용인중앙 이용 시 참고",
        "처인은 원도심 주거와 역북 신축 세대가 함께 많아 자택 방문 관리와 타이·스웨디시 문의가 꾸준합니다. 에버라인 용인중앙시장역·김량장역으로 기흥·수지 이동이 가능하나 방문은 실제 주소 기준으로 안내됩니다."),
      "gwoldong-unam": ("궐동·운암 이용 시 참고",
        "궐동은 대학가 1인 세대, 운암은 가족 주거 세대가 섞여 있어 스웨디시·발마사지 문의가 다양하게 들어옵니다. 오산시청 인접 대단지는 방문 차량 등록 확인이 방문 시간을 단축합니다."),
      "hwaseong-namyang": ("화성 남양 이용 시 참고",
        "남양·송산은 행정 주거와 신도시 세대가 함께 많아 자택 방문 관리와 스웨디시·아로마 문의가 꾸준합니다. 외곽·해안권은 이동 거리에 따라 예약 가능 시간이 달라지므로 정확한 주소를 미리 알려주시면 좋습니다."),
      "hyangnam-bongdam": ("향남·봉담 이용 시 참고",
        "향남·봉담은 제약·산단 배후 이용과 택지 가족 세대 이용이 섞여 있어 스포츠 마사지·스웨디시 문의가 함께 들어옵니다. 철도가 없는 지역 특성상 이동 거리에 따라 예약 가능 시간이 달라지므로 정확한 주소를 예약 시 미리 알려주시면 원활합니다."),
      "icheon-bubal": ("이천·부발 이용 시 참고",
        "이천·부발은 반도체 산단 배후 장기 체류 이용과 증포 가족 세대 이용이 섞여 있어 스포츠 마사지·스웨디시 문의가 꾸준합니다. 경강선으로 판교 이동이 가능하나 방문은 실제 주소 기준으로 안내됩니다."),
    })
